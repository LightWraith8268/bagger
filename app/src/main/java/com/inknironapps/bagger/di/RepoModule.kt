...
import com.inknironapps.bagger.data.repo.OwnedDiscPhotoRepositoryImpl
...
abstract class RepoModule {
    ...
    @Binds @Singleton abstract fun bindOwnedDiscPhoto(impl: OwnedDiscPhotoRepositoryImpl): OwnedDiscPhotoRepository
